...
@uberurl ="https://m.uber.com/ul/?action=setPickup&client_id=2oVqH3_uKKBif3xXNrXY-EpG5hLjguJi&pickup[formatted_address]="+@origin+"&pickup[latitude]="+@start_lat.to_s+"&pickup[longitude]="+@start_lng.to_s+"&dropoff[formatted_address]="+@destination+"&dropoff[latitude]="+@end_lat.to_s+"&dropoff[longitude]="+@end_lng.to_s
